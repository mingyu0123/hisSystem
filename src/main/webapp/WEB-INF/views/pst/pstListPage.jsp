...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
				...
				<h2 style="text-align: center;font-weight: bold;font-size:25px">처방전</h2>
				<div style="text-align: right;">
					<select id="searchType" class="form-control" style="width: 120px;display: initial;font-size: 15">
						<option value="title" <c:if test="${searchType == 'title' }">selected="selected"</c:if>>제목</option> 
						<option value="writer" <c:if test="${searchType == 'writer' }">selected="selected"</c:if>>처방의사</option>
					</select>
				...
				<table class="table table-hover" style="margin-top:30px;">
				  ...
				  <tbody>
				  	<c:forEach items="${list}" var="pst" varStatus="sta">
						<tr onclick="fnDetail(${pst.pstSeq},${paging.nowPage },${paging.cntPerPage })">
